    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-4">
      <div className="w-full max-w-md">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    disabled={loading}
                    className="w-full pl-3 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                    placeholder="John"
                  />
                </div>
              </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  disabled={loading}
                  className="w-full pl-3 pr-10 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                  placeholder="••••••••"
                />
                <button
                  type="button"
        ...
        <div className="mt-8 text-center text-xs text-gray-500">
          <p>© 2026 Todo AI. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
